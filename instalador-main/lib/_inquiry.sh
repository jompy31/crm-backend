...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingresa el enlace GITHUB de tu ABChat que deseas instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
get_max_whats() {
  ...
  print_banner
  printf "${WHITE} 💻 Informe a Qtde de Conexiones/Whats que a ${instancia_add} puedes registrarte:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_whats
}
...
get_max_user() {
  ...
  print_banner
  printf "${WHITE} 💻 Informe a Qtde de Usuarios/Atendentes que a ${instancia_add} puedes registrarte:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_user
}
...
get_alter_frontend_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Ingrese el puerto FRONT END de la Instancia/Empresa${empresa_dominio}; El puerto debe ser el mismo que el especificado durante la instalación.${GRAY_LIGHT}"
  printf "\n\n"
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bienvenido al ABCchat Manager - Servicio ilimitado, ¡selecciona tu próxima acción a continuación!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar ABCchat\n"
  printf "   [1] Atualizar ABCchat\n"
  printf "   [2] Deletar ABCchat\n"
  printf "   [3] Bloquear ABCchat\n"
  printf "   [4] Desbloquear ABCchat\n"
  printf "   [5] Alter. dominio ABCchat\n"
  printf "\n"
  read -p "> " option
