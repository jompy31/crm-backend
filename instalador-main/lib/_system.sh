...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻Descargando el código ABCchat...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻Actualicemos el sistema ABChat...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos eliminar ABCchat...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear ABCpechat...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Bloqueo de instancias/Empresa ${empresa_bloquear} llevado a cabo con éxito ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o ABChat...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do ABChat...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Cambio de dominio de instancia/Empresa ${empresa_dominio} llevado a cabo con éxito ...${GRAY_LIGHT}"
  printf "\n\n"
